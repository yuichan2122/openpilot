...
DAYS_NO_CONNECTIVITY_MAX = 999  # do not allow to engage after a week without internet -> changed to 999 days
DAYS_NO_CONNECTIVITY_PROMPT = 999  # send an offroad prompt after 4 days with no internet -> changed to 999 days
